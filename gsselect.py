...
def parangle(coord, location, time, verbose=True):
    """
...
def gsselect(target, ra, dec, pa=0.0, wfs='OIWFS', ifu=None,
             site='N', fixpa=False, findpa=False, cat='UCAC4', chopping=False,
             imdir='./', overwrite=False, rmin=-1.0, pad=0.0, inst='GMOS', port='side',
             testpa=False, degstep=-1., parmode=False, utdate=None, time=None, dst=0.,
             iq='70', cc='50', sb='50', display=True, verbose=True):
    ...
    """Gemini guide star selection
       ...
       Parameters
        ...
        wfs:        Wavefront sensor ['OIWFS', 'PWFS1', 'PWFS2']
        ifu:        GMOS IFU ['two', 'red', 'blue']
        site:       Gemini site ['N','S','mko','cpo']
        fixpa:      Fix the PA to the input value
        findpa:     Calculate the best PA for the selected guide star
        ...
        parmode:    Put slit along the parallactic angle
        ...
        cc:         Cloud cover constraint [0.0, -0.3, -1.0, -3.0]
        sb:         Sky brightness constraint ['20','50','80','Any']
        display:    Display image of field?
        verbose:    Verbose output?
...
if __name__ == "__main__":
    ...
    gstar, gsra, gsdec, gsmag, gspa = gsselect(target,ra,dec,pa,imdir='test/', site='gs', pad=5.,
             inst='GMOS', wfs='OIWFS', fixpa=False, findpa=False, overwrite=False,
            parmode=True, utdate=utdate, time=uttime, dst=1, display=True, verbose=True)
    print(gstar, gsra, gsdec, gsmag, gspa)

    gstar, gsra, gsdec, gsmag, gspa = gsselect(target,ra,dec,pa,imdir='test/', site='gn', pad=5.,
             inst='GNIRS', wfs='PWFS2', fixpa=False, findpa=False, overwrite=False,
            parmode=True, utdate=utdate, time=uttime, dst=0, display=True, verbose=True)
    print(gstar, gsra, gsdec, gsmag, gspa)

    gstar, gsra, gsdec, gsmag, gspa = gsselect(target,ra,dec,pa,imdir='test/', site='gn', pad=5.,
             inst='NIRIf/6', wfs='PWFS2', fixpa=False, findpa=False, overwrite=False,
            parmode=True, utdate=utdate, time=uttime, dst=0, display=True, verbose=True)
    print(gstar, gsra, gsdec, gsmag, gspa)


    # print('GMOS-N OI')
    # mmin, mmax = maglimits('GMOS-N','OIWFS','N','70','50','50',verbose=True)
    # print(mmin,mmax)
    #
    # mmin, mmax = maglimits('GMOS-N','OIWFS','N','20','50','20',verbose=True)
    # print(mmin,mmax)
    #
    # mmin, mmax = maglimits('GMOS-N','OIWFS','N','Any','50','Any',verbose=True)
    # print(mmin,mmax)
    #
    # print('GMOS-S OI')
    # mmin, mmax = maglimits('GMOS-S','OIWFS','S','70','50','50',verbose=True)
    # print(mmin,mmax)
    #
    # mmin, mmax = maglimits('GMOS-S','OIWFS','S','20','50','20',verbose=True)
    # print(mmin,mmax)
    #
    # mmin, mmax = maglimits('GMOS-S','OIWFS','S','Any','50','Any',verbose=True)
    # print(mmin,mmax)
    #
    # print('PWFS1 S')
    # mmin, mmax = maglimits('GMOS-S','PWFS1','S','70','50','50',verbose=True)
    # print(mmin,mmax)
    #
    # mmin, mmax = maglimits('GMOS-S','PWFS1','S','20','50','20',verbose=True)
    # print(mmin,mmax)
    #
    # mmin, mmax = maglimits('GMOS-S','PWFS1','S','Any','50','Any',verbose=True)
    # print(mmin,mmax)
    #
    # print('PWFS2 S')
    # mmin, mmax = maglimits('GMOS-S','PWFS2','S','70','50','50',verbose=True)
    # print(mmin,mmax)
    #
    # mmin, mmax = maglimits('GMOS-S','PWFS2','S','20','50','20',verbose=True)
    # print(mmin,mmax)
    #
    # mmin, mmax = maglimits('GMOS-S','PWFS2','S','Any','50','Any',verbose=True)
    # print(mmin,mmax)
    #
    # print('PWFS1 N')
    # mmin, mmax = maglimits('GMOS-S','PWFS1','N','70','50','50',verbose=True)
    # print(mmin,mmax)
    #
    # mmin, mmax = maglimits('GMOS-S','PWFS1','N','20','50','20',verbose=True)
    # print(mmin,mmax)
    #
    # mmin, mmax = maglimits('GMOS-S','PWFS1','N','Any','50','Any',verbose=True)
    # print(mmin,mmax)
    #
    # print('PWFS2 N')
    # mmin, mmax = maglimits('GMOS-S','PWFS2','N','70','50','50',verbose=True)
    # print(mmin,mmax)
    #
    # mmin, mmax = maglimits('GMOS-S','PWFS2','N','20','50','20',verbose=True)
    # print(mmin,mmax)
    #
    # mmin, mmax = maglimits('GMOS-S','PWFS2','N','Any','50','Any',verbose=True)
    # print(mmin,mmax)
